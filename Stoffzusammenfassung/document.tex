...
\hspace*{2.5mm}- \textbf{Tail-Drop:} neu angekommendes Paket verwerfen\\
\hspace*{2.5mm}- \textbf{Priority:} Paket mit geringster Priorität verwerfen\\
\hspace*{2.5mm}- \textbf{Random:} Zufälliges Paket verwerfen
...
\begin{tabular}{ll}
	\makecell[l]{
		$\circ$ Verallgemeinerung von \textit{WRR} und paketbasierte Approximation von \textit{GPS}\\
...
$\circ$ Ziel ist Überwachung einer Klasse und Regeln der Raten, mit der diese Pakete einspeist\\
$\circ$ Kriterien sind\\
...
\hspace*{2.5mm}- \textbf{Assured Forwarding:} 4 Verkehrsklassen, jeweils 3 Kategorien für Verwerfen bei Überlast, mit garantiert minimaler Bandbreite

\vspace{-2.75em}
\subsection{Integrated Services (IntServ)}
\vspace{-1.75em}
$\circ$ Garantiert Datenrate/Dienstgüte, die erfordern:\\
\hspace*{2.5mm}- \textbf{Ressourcenreservierung:} Zuteilung der benötigten Ressourcen bei Verbindungsaufbau von Datenstrom\\
\hspace*{2.5mm}- \textbf{Call Admission:} Abweisung eines Datenstroms bei Anforderung von nicht mehr verfügbaren Ressourcen\\
