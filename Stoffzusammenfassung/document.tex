...
\vspace{-1em}
\begin{tabular}{ll}
	\raisebox{-.5\height}{\includegraphics[scale=0.25]{images/digitale_signatur.png}} &
	\makecell[l]{
		$\circ$ Lösung:\\
...
$\circ$ Lösungen: \textit{shared secret} oder Verwendung einer nur einmal verwendeten, zufälligen Zahl (\textit{Nonce}),\\
...
\begin{tabular}{ll}
	...
	\makecell[l]{$\circ$ Aufteilung des TCP-Byte-Stroms in separate Abschnitte (\textit{SSL Records})\\
		$\circ$ Jeder Record enthält \textbf{zusätzliche Sequenznummer} (beginnend bei 0) um\\\hspace*{5mm}Reordering von Records verhindern\\
