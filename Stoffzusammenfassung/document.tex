...
\begin{itemize}
	...
	\vspace{-1em}
	\begin{enumerate}[itemsep=-1em]
		\item Teilnehmer nutzen unterschiedliche Spreizcodes
		\item Zu übertragende Daten werden mit Code multipliziert (gespreizt), Ergebnisbits $\Leftrightarrow$ \textbf{Chips}
